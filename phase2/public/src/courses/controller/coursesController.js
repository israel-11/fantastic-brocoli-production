...
.controller('coursesController',['$scope','$compile','$location','studentService', function($scope, $compile, $location, studentService) {
  ...
  //  ];
   ...
   $scope.donate = function(){
    ...
    //    )
    //  })
        var senderName = 'Nelson';
        var recipientName = 'Israel';
        var recipientPhone = '7875181788';
        var recipientEmail = 'israel.figueroa1@upr.edu';
        var demo = 'yifti';
        var production = 'yiftee';
        var page = 'http://app.'+demo+'.com/api/v1/gifts/send.html?api_token=1a461040ef067dea7f40fd8ef3b2663c4&sender_name='+senderName+'&recipient_name='+recipientName+'&recipient_phone='+recipientPhone+'&recipient_email='+recipientEmail
        swal({
